class ProductListItem {
  ...
  ProductListItem.fromJson(Map<String, dynamic> json) {
    print('discount perc------------------> ${json['cal_discount_percentage']}');
    id = json['id'].toString();
    ...
    discount_perc = json['cal_discount_percentage'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cal_discount_percentage'] = this.discount_perc;
...
class Variants {
  ...
  Variants.fromJson(Map<String, dynamic> json) {
    ...
    discountedPrice = json['normal_discounted_price'].toString();
    PriceGST = json['price'].toString();
    discountedPriceGST = json['discounted_price'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['normal_price'] = price;
    data['normal_discounted_price'] = discountedPrice;
    data['price'] = PriceGST;
    data['discounted_price'] = discountedPriceGST;
